...
function ResponseSection(){
    ...
    return(
        <>
            ...
            <div className='flex flex-col gap-1 border-[1.5px] rounded-2xl border-[#E2E8F0] overflow-hidden'>
                ...
                <div className='border-t-[#E2E8F0] border-t-[1px]'>
                    <div className="bg-white">
                        ...
                        <div className='flex justify-between pb-3 px-3 items-center box-border'>
                            ...
                            {(
                                <div className="flex flex-row-reverse h-full gap-2">
