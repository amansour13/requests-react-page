...
function TestGrid(){
    ...
    return (
        <div className="grid grid-cols-12 grid-rows-[1fr_5fr] w-full h-full gap-[0.05rem]">
            <div className={`${isOpen ? 'col-span-2' : 'col-span-1'} row-span-2 grid grid-cols-3 relative`}>
                <div className={`bg-white ${isOpen ? 'col-span-1' : 'col-span-3'}`}>
                    <NavMenu />
                </div>
            ...
            <div className={`${isOpen ? 'col-span-10' : 'col-span-11'} grid grid-rows-2 gap-[0.05rem]`}>
                <div className="bg-white">page title</div>
                <div className="bg-white">tabs titles</div>
            </div>
            <div className={`${isOpen ? 'col-span-7' : 'col-span-8'} grid grid-rows-[3fr_2fr] gap-[0.05rem]`}>
